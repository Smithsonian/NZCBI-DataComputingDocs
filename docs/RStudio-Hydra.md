...
### b) [R](https://cran.r-project.org/) session differences
...
For additional information on using [R-Studio](https://posit.co/download/rstudio-desktop) Server, please see the full reference documentation provided on High Performance Computing: [Using the R-Studio Server](https://confluence.si.edu/spaces/HPC/pages/385975502/Using+the+RStudio+Server).