## Introduction
Proper “data management” often means different things to different people depending on what one’s role is. When considered from an organizational perspective though, it quickly becomes clear that these different meanings and roles are linked together in a repeating workflow. This is the data management life cycle. 

Different sources will break the cycle down in different ways. Here we present an extension of the structures used by [USGS](https://www.usgs.gov/data-management/data-lifecycle) and the [Harvard Business School](https://online.hbs.edu/blog/post/data-life-cycle). 

We also recommend reviewing the [Harvard Biomedical Data Lifecycle](https://datamanagement.hms.harvard.edu/plan-design/biomedical-data-lifecycle) for a more detailed approach 
